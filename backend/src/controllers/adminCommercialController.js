...
async function updateInvestor(req,res){try{res.json(await svc.updateInvestorSettings(req.body))}catch(e){console.error(e);res.status(500).json({error:'Failed to save investor settings'})}}
