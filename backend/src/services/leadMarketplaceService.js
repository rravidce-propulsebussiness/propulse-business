...
async function getMarketplacePage({industryId,serviceId,subserviceId,stateId,cityId,status='available',leadType,search,allIndustries,userId,role,page=1,limit=20}){
 ...
 // Customer default matching: every available lead matching ANY active profile industry AND ANY active profile state. City/service filters remain optional refinements.
