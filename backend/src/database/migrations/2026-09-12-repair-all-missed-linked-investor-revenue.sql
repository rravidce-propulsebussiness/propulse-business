-- Repair any paid lead purchase explicitly linked to an investor that still has no
-- revenue allocation. Explicit lead ownership is authoritative, so do not require
-- the lead location to match the investment location.
WITH candidates AS (
