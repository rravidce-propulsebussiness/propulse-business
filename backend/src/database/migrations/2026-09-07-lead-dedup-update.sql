...
DROP TRIGGER IF EXISTS trg_prevent_duplicate_lead_update ON leads;
CREATE TRIGGER trg_prevent_duplicate_lead_update
BEFORE UPDATE OF industry_id, customer_phone, customer_email, customer_name, requirement ON leads
FOR EACH ROW
EXECUTE FUNCTION prevent_duplicate_lead_change();
