...
-- Replaces the old practice of executing selected legacy SQL files directly.
-- Safe for both fresh databases and existing installations because statements are idempotent.
