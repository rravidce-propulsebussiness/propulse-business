    ...
    const loadStatement = async (userId, cycleId, box, button) => {
      ...
      try {
        ...
        investments.forEach(investment => {
          ...
          ;(spendMap.get(Number(investment.id)) || []).forEach(spend => events.push({ type: 'ad', label: `Ads spent · Investment #${investment.id}`, amount: -Math.abs(Number(spend.amount || 0)), date: spend.spend_date || spend.created_at }))
        })
