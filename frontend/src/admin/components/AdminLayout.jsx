...
export default function AdminLayout() {
  ...
  const page = location.pathname === '/admin' ? 'Overview' : location.pathname.includes('industries') ? 'Industries & Services' : location.pathname.includes('businesses') ? 'Businesses' : location.pathname.includes('payments') ? 'Payments' : 'Users';
