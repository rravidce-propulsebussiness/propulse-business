...
const links = [
  ...
  { to: '/admin/payment-receiving', label: 'Payment Receiving', icon: '▣' },
  { to: '/admin/investments', label: 'Investments', icon: '↗' },
  { to: '/admin/investment-ad-allocations', label: 'Ad Allocations', icon: '▤' },
  { to: '/admin/investor-transfer-requests', label: 'Investor Transfers', icon: '⇄' },
