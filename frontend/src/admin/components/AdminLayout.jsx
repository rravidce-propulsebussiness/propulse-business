...
export default function AdminLayout() {
  ...
  const isPaymentReceiving = location.pathname === '/admin/payments' && new URLSearchParams(location.search).get('section') === 'bank';
