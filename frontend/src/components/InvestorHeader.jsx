...
export default function InvestorHeader(){
 ...
 const nav=isPro?[{label:'Home',to:'/'},{label:'Investment',to:'/investment'},{label:'Linked Leads',to:'/investment/leads'},{label:'Withdrawals',to:'/investment/payouts'},{label:'FAQ',to:'/investment/faq'}]:[{label:'Home',to:'/'}]
