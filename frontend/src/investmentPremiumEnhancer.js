...
function refineExistingContent() {
  const page = document.querySelector('.investment-page')
  if (!page) return
  document.querySelectorAll('.sold-leads-card,.investment-history,.investor-payout-transfers,.reinvestment-choice-card').forEach(node => node.classList.add('investment-hidden-section'))
...
function scan() { refineExistingContent() }
