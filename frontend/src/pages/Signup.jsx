          ...
          <form className="signup-form" onSubmit={openBusinessDetails}>
            <section className="signup-form-section">
              <div className="signup-form-grid">
                ...
                <label>Password<div className="signup-password-field"><input name="password" type={showPassword ? 'text' : 'password'} autoComplete="new-password" minLength={8} pattern="(?=.*[A-Za-z])(?=.*[0-9]).{8,}" title="Use at least 8 characters with letters and numbers, e.g. Ravi143" value={form.password} onChange={(e) => update('password', e.target.value)} placeholder="Example: Ravi143" required /><button type="button" onClick={() => setShowPassword(v => !v)}>{showPassword ? 'Hide' : 'Show'}</button></div></label>
