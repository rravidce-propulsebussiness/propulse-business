            ...
            {groups.map((group) => {
              ...
              return (
                <article className={`membership-plan ${group.type}-plan ${locked ? 'access-locked' : ''}`} key={group.key}>
                  ...
                  {group.type === 'investor' && <div className="investor-flow"><span>1. Fund an eligible industry</span><span>2. Lead sales generate realized revenue</span><span>3. Your share is settled at maturity</span><span>4. You choose whether to keep or reinvest the realized payout</span></div>}
