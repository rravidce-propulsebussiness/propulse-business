...
export default function Membership() {
  ...
  const openPayment = plan => {
    ...
    if (planType === 'investor' || planType === 'investment') { setError(isProMember ? 'Investor access is unlocked by an active Pro membership. It is not purchased separately.' : 'Investor access is available only to customers with an active Pro membership.'); return }
