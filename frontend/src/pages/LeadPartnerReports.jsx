    ...
    <main className="reports-main">
      ...
      <div className="reports-content">
        ...
        <section className="reports-kpi-grid">
          ...
          <article><div className="reports-kpi-icon green">✓</div><div><span>Verified Genuine</span><strong>{loading?'—':counts.verified_genuine}</strong></div></article>
          <article><div className="reports-kpi-icon red">!</div><div><span>Verified Fake</span><strong>{loading?'—':counts.verified_fake}</strong></div></article>
          <article><div className="reports-kpi-icon orange">◷</div><div><span>Pending Review</span><strong>{loading?'—':counts.pending}</strong></div></article>
        </section>
        <section className="reports-analytics-grid">
          <article className="reports-card"><div className="reports-card-head"><div><h2>Report status</h2></div></div><div className="reports-status-bars">
          ...
          <article className="reports-card"><div className="reports-card-head"><div><h2>Report reasons</h2></div></div>{reasonCounts.length?<div className="reports-reasons">{reasonCounts.map(x=><div key={x.key}><span className="reason-dot"/><span>{x.label}</span><b>{x.count}</b></div>)}</div>:<div className="reports-empty-mini">No reports submitted yet.</div>}</article>
        </section>
