...
export default function LeadsV2() {
  ...
  return <div className="lv2-shell">
    ...
    <main className="lv2-page">
      ...
      <section className="lv2-bottom-cta"><div><span className="lv2-kicker">GROW WITH PROPULSE</span><h2>Find the right opportunity for your business.</h2><p>Browse, compare and choose leads with transparent pricing.</p></div>{logged ? <Link to="/dashboard">Go to dashboard →</Link> : <Link to="/signup">Create business account →</Link>}</div></section>
    </main>
