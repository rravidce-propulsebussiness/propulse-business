...
function LoggedInHomeRoute(){const token=getToken(),user=getUser();if(token&&user)return <Navigate to={user.role==='admin'?'/admin':'/dashboard'} replace/>;return <Home/>}
